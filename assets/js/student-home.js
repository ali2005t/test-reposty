...
async function init() {
    ...
    // 404
    if (!tid) {
        splash.innerHTML = '<h1>404</h1><p style="color:white;">رابط غير صحيح</p>';
        return;
    }
    ...
    try {
        ...
        if (teacherDoc.exists()) {
            ...
            document.getElementById('splash-name').innerText = platformName;
            document.getElementById('platform-name').innerText = platformName;
            document.getElementById('hero-platform-name').innerText = platformName;
            document.getElementById('footer-platform-name').innerText = platformName;
            ...
            if (data.platformColor) {
                document.documentElement.style.setProperty('--primary', data.platformColor);
            }
