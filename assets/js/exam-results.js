...
onAuthStateChanged(auth, async (user) => {
    if (user) {
        ...
        const impersonatedId = sessionStorage.getItem('impersonatedTeacherId');
        if (impersonatedId) {
            console.log("Viewing as Teacher:", impersonatedId);
            // Override uid for queries
            currentUser = { ...user, uid: impersonatedId, isImpersonating: true };
        }
